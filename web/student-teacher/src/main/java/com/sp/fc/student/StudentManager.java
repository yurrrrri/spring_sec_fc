...
public class StudentManager implements AuthenticationProvider, InitializingBean {
    ...
    public List<Student> myStudents(String teacherId) {
        return studentDB.values().stream()
                .filter(s -> s.getTeacherId().equals(teacherId)).collect(Collectors.toList());
    }

    @Override
    public void afterPropertiesSet() throws Exception {
        Set.of(
                new Student("yuri", "유리", Set.of(new SimpleGrantedAuthority("ROLE_STUDENT")), "choi"),
                new Student("may", "메이", Set.of(new SimpleGrantedAuthority("ROLE_STUDENT")), "choi"),
                new Student("henny", "혜니", Set.of(new SimpleGrantedAuthority("ROLE_STUDENT")), "choi")
